...
import { z } from 'zod';
import { Lock, Eye, EyeOff, Loader2, ShieldAlert, CheckCircle2, ArrowLeft } from 'lucide-react';
  ...
  const onSubmit = async (values: ResetPasswordValues) => {
    ...
    try {
      ...
      if (response.status === 'success') {
        ...
        setApiError(response.message || 'Reset failed. Try again.');
      }
    } catch (error: any) {
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-extrabold text-slate-100 tracking-tight">Reset Password</h1>

...
router.get('/', authorize(['SuperAdmin', 'OrgAdmin', 'HR', 'Manager', 'Employee']), asyncHandler(getProjectSprints));
router.get('/:id', authorize(['SuperAdmin', 'OrgAdmin', 'HR', 'Manager', 'Employee']), asyncHandler(getSprintById));
